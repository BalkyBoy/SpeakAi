...
export const lessonControllerGetAll = <ThrowOnError extends boolean = false>(options?: Options<LessonControllerGetAllData, ThrowOnError>) => (options?.client ?? client).get<LessonControllerGetAllResponses, unknown, ThrowOnError>({ url: '/lesson', ...options });
...
export const dashboardControllerGetDashboardData = <ThrowOnError extends boolean = false>(options?: Options<DashboardControllerGetDashboardDataData, ThrowOnError>) => (options?.client ?? client).get<DashboardControllerGetDashboardDataResponses, unknown, ThrowOnError>({ url: '/dashboard', ...options });
